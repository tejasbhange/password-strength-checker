...
✅ 100% client-side — no data stored or sent anywhere  
...
- **CSS3**
- **JavaScript (ES6)**
- **zxcvbn.js** (Dropbox password strength estimator)
...
1. Download or clone the repository:
   ```bash
   git clone https://github.com/tejasbhange/password-strength-checker.git
